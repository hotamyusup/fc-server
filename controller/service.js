...
exports.send = {
    handler: function (request, reply) {
        ...
        gm(Map).fill("red").stroke("white",2).drawCircle(request.payload.PosX, request.payload.PosY, request.payload.PosX + 10, request.payload.PosY + 10).resize(800, null).write(Target, 
        	function(err){
	    ...
	    var Pointer = "<img src=\""+Target.replace("./","http://104.131.141.177/")+"\" width=\"90%\" />";

	    var mailOptions = {
	        from: from,
	        to: to, 
	        subject:'Service Reqest: '+request.payload.User,
	        html: "<b>Request Service Details:</b><br /><br /><b>User:</b> "+request.payload.User+"<br><b>E-Mail:</b> "+request.payload.Email+"<br><b>Phone:</b> "+request.payload.Phone+"<br><b>Property:</b> "+request.payload.Property+"<br><b>Building:</b> "+request.payload.Building+"<br><b>Floor:</b> "+request.payload.Floor+"<br><b>Device Type:</b> "+request.payload.DeviceType+"<br><b>Equipment Type:</b> "+request.payload.EquipmentType+"<br><b>Installation Date:</b> "+request.payload.InstallationDate+"<br><b>Location:</b> "+request.payload.Device.DeviceLocation+"<br><b>Notes:</b> "+request.payload.Device.Notes+"<br><b>Comments:</b> "+request.payload.Comments+"<br><br><b>History:</b> "+History+"<br><br><b>Photo:</b> <br>"+Photo+"<br><br><b>Map:</b> <br>"+Pointer
		}		  
