...
exports.get = {
    handler: function (request, reply) {
        ...
        OccupancyType.findOne({ '_id' : request.params.OccupancyTypeID }, function (err, occupancytype) {
            if (!err) {
...
exports.create = {
    handler: function (request, reply) {
        ...
        occupancytype.save(function (err, occupancytype) {
            if (!err) {
                return reply(occupancytype).created('/occupancytype/' + occupancytype._id); // HTTP 201
            }
