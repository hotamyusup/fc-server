...
exports.get = {
    handler: function (request, reply) {
        ConstructionType.findOne({ '_id' : request.params.ConstructionTypeID }, function (err, constructiontype) {
            if (!err) {
...
exports.create = {
    handler: function (request, reply) {
        ...
        constructiontype.save(function (err, constructiontype) {
            if (!err) {
                return reply(constructiontype).created('/constructiontype/' + constructiontype._id); // HTTP 201
            }
