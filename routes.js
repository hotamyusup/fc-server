...
exports.endpoints = [
    ...
    { method: 'GET', path: '/organizations/{OrganizationID}', config: Organization.get},
    { method: 'GET', path: '/organizations/{OrganizationID}/users', config: User.list},

    { method: 'POST', path: '/organizations', config: Organization.create},
    { method: 'POST', path: '/organizations/{OrganizationID}', config: Organization.update},

    { method: 'GET', path: '/constructiontypes', config: ConstructionType.all},
    { method: 'GET', path: '/constructiontypes/{ConstructionTypeID}', config: ConstructionType.get},

    { method: 'POST', path: '/constructiontypes', config: ConstructionType.create},
    { method: 'POST', path: '/constructiontypes/{ConstructionTypeID}', config: ConstructionType.update},

    { method: 'GET', path: '/occupancytypes', config: OccupancyType.all},
    { method: 'GET', path: '/occupancytypes/{OccupancyTypeID}', config: OccupancyType.get},

    { method: 'POST', path: '/occupancytypes', config: OccupancyType.create},
    { method: 'POST', path: '/occupancytypes/{OccupancyTypeID}', config: OccupancyType.update},
    ...
    { method: 'POST', path: '/equipments/{EquipmentID}', config: Equipment.update},

    { method: 'POST', path: '/equipments/device/{EquipmentID}', config: Equipment.upsertdevice},
    { method: 'POST', path: '/equipments/device/{EquipmentID}/{DeviceID}', config: Equipment.upsertdevice},
