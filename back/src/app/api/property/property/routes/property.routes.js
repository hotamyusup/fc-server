...
const PROPERTY_ROUTES = [
    {method: 'GET', path: '/properties/export-csv', config: PropertyController.exportCSV},
    {method: 'GET', path: '/properties/processed/{PropertyID}', config: PropertyController.processed},
